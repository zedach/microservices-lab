...
We've prepared a small https://github.com/debezium/microservices-lab/tree/master/hiking-demo[CRUD microservice for managing orders of events], which we'll use in the following as source of data change events.
