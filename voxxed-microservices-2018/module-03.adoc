...
We've prepared a small https://github.com/strimzi/strimzi-lab/tree/master/hiking-demo[CRUD microservice for managing hikes], which we'll use in the following as source of data change events.
...
```console
$ oc cluster down
$ rm $HOME/openshift.local.clusterup
```
