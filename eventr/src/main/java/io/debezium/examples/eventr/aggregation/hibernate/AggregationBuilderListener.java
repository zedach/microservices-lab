...
import io.debezium.examples.eventr.aggregation.connect.KafkaConnectSchemaFactoryWrapper;
import io.debezium.examples.eventr.aggregation.connect.KafkaConnectSchemaFactoryWrapper.KafkaConnectSchemaAdapterFactory;
import io.debezium.examples.eventr.aggregation.hibernate.Aggregate.AggregateKey;
...
//                        }
                        ...
                        ((Session) session).saveOrUpdate(aggregate);
                        session.flush();
                    }
...
//                        }
                        ...
                        String idString = "{ \"" + idProperty + "\" : " + mapper.writeValueAsString(id) + " }";
                        Aggregate aggregate = ((Session) session).load(Aggregate.class, new AggregateKey(idString, aggregateName));
