 ...
 */
package io.debezium.examples.eventr.aggregation.connect;
...
//                System.out.println(((ReferenceSchema)getItems().asSingleItems().getSchema()).get$ref());
//                System.out.println(((ReferenceSchema)getItems().asSingleItems().getSchema()).get$schema());
//                System.out.println(((ReferenceSchema)getItems().asSingleItems().getSchema()).getTitle());
//                System.out.println(((ReferenceSchema)getItems().asSingleItems().getSchema()).getType());
//                System.out.println(((ReferenceSchema)getItems().asSingleItems().getSchema()).getDescription());
                System.out.println(getItems().asSingleItems().getSchema().getId());
